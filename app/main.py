...
from .routers import account, admin, auth, community, dashboard, events, notifications, opportunities, projects, public, questions, tasks
...
for router in [public.router, auth.router, dashboard.router, community.router, questions.router, projects.router, events.router, account.router, admin.router, tasks.router, tasks.subtasks_router, opportunities.router, notifications.router]:
